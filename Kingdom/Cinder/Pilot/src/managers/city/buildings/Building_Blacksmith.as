package managers.city.buildings 
{
	...
	public class Building_Blacksmith extends Building 
	{
		...
		private static const _resourceCost:ResourceCollection = new ResourceCollection(50, 10, 20);
		...
		{
			super(id, "data/gfx/buildings/blacksmith.png", null, 2, 2, Building_Blacksmith.name, Building_Blacksmith.maxHealth);
		}
