package org.flixel
{
	...
	public class FlxText extends FlxSprite
	{
		...
		/**
		 * Internal value for derived classes to allow to be always drawn
		 */
		protected var _optimizeDisplay:Boolean = true;
		...
		override protected function calcFrame():void
		{
			...
			if((_textField != null) && (_textField.text != null) && (_textField.text.length > 0 || !_optimizeDisplay))
			{
